package com.weg.oficina.recuperacao.demo;
        ...
        while (opcao == 0) {
            ...
            switch (opcao) {
                case 1: // SINALIZAR PROBLEMA
                    System.out.print("Seu Nome: "); String q =
                        sc.nextLine();
                    System.out.print("Equipamento com defeito: "); String
                        e = sc.nextLine();
                    System.out.print("Descrição do problema: "); String d
                        = sc.nextLine();
                    System.out.println("\n[REGISTRO]: " + q + " sinalizou falha no equipamento " + e + ".");
                    break;
                case 2: // ABRIR OS (Professor)
                        System.out.print("Digite seu ID de Professor: "); int
                        idProf = sc.nextInt();
                    if (idProf == totalPessoas |
                            !usuariosTipos[idProf].equals("PROFESSOR")) {
                        System.out.println("ERRO: Acesso negado. Apenas professores podem abrir OS.");
                        break;
                    }
                    osId[totalOS] = totalOS + 1;
                    System.out.print("Equipamento: "); sc.nextLine();
                ...
                case 3: // EXECUTAR (Alunos)
                    System.out.print("ID da OS: "); int idEx =
                        sc.nextInt() - 1;
                    System.out.print("Seu ID de Aluno: "); int idAlu =
                        sc.nextInt();
                    ...
                    if (autorizado & osStatus[idEx].equals("EXECUTANDO")) {
                        System.out.print("Materiais e Quantidades utilizadas: "); sc.nextLine();
                ...
                case 4: // APROVAR (Professor)
                    System.out.print("ID da OS: "); int idAp =
                        sc.nextInt() - 1;
                    System.out.print("ID do Professor: "); int idPrAp =
                        sc.nextInt();
